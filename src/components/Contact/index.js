...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Формирование текста для отправки в телеграм-бота
    ...
    try {
      ...
      const response = await fetch(
        `https://api.telegram.org/bot6433749359:AAG15K7HT4KHhn_o2YAI4qpRlqMa8GXLrPQ/sendMessage`,
        {
          method: 'POST',
          headers: {
      ...
      if (response.ok) {
        ...
        // Добавьте здесь код для обработки успешной отправки в телеграм
        ...
        // Добавьте здесь код для обработки ошибки при отправке в телеграм
      }
    } catch (error) {
        ...
        <div className="flex-auto w-full md:w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/sulton03", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/sulton.off_",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/profile.php?id=100065353614829",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>2023 Abduraximov Sulton</span>
            </div>
          </div>
        </div>
        <ToastContainer
